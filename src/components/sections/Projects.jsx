				...
				>
					...
					<div className="p-5 flex flex-col h-full">
						...
						<p className="text-xs font-mono text-slate-500 dark:text-slate-600 mb-2.5 flex items-center gap-1">
							<Zap
								className="w-3 h-3 text-orange-500/50 flex-shrink-0"
								aria-hidden="true"
							/>
							{project.impact}
						</p>
...
function Projects() {
	...
	const allProjects = useMemo(
		() => enrichProjects(PROJECTS, npmData),
		[npmData],
	);
			...
			<div className="section-container">
				<AnimatedSection>
					...
					<p className="section-subtitle">
						npm packages, full-stack apps, frontend experiments — each one
						shipped with care for performance and developer experience.
					</p>
				</AnimatedSection>
